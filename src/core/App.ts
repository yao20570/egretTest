...
class App {
     ...
     * @type {string}
     */
    public static ProxyUserKey: string = "";
     ...
     * @type {XxteaUtils}
     */
    public static get XxteaUtils(): XxteaUtils {
        return XxteaUtils.getInstance();
    }
    ...
    /**
     * 序列帧特效管理类
     * @returns {ParticleUtils}
     * @constructor
     */
    public static get ParticleUtils(): ParticleUtils {
        return ParticleUtils.getInstance();
    }
    ...
    public static Init(): void {
        ...
        //实例化Socket请求
        App.Socket.initServer(new ByteArrayMsgByJson());
    }
}
