...
class TimerManager extends BaseClass {
    ...
    private create(useFrame: boolean, delay: number, repeatCount: number, method: Function, methodObj: any, complateMethod: Function, complateMethodObj: any): TimerHandler {
        //参数监测
     ...
     *
     */
    public doTimer(delay: number, repeatCount: number, method: Function, methodObj: any, complateMethod: Function = null, complateMethodObj: any = null): TimerHandler {
     ...
     *
     */
    public doFrame(delay: number, repeatCount: number, method: Function, methodObj: any, complateMethod: Function = null, complateMethodObj: any = null): TimerHandler {
        return this.create(true, delay, repeatCount, method, methodObj, complateMethod, complateMethodObj);
    }
    ...
    /**
     * 移除自定义计时器，移除后务必手动释放此handler对象
     * @param handler 要移除的计时器
     *      
     */
    public removeByHandler(handler: TimerHandler): void {
        this.remove(handler.method, handler.methodObj);
    }
     ...
     *
     */
    public isExistsByHandler(handler: TimerHandler): boolean {
        return this.isExists(handler.method, handler.methodObj);
    }
}
