 ...
 * 武将相关代理层
 */
class HeroProxy extends BaseProxy {
    public constructor($controller: BaseController) {
        super($controller);
        //注册从服务器返回消息的监听(协议不属于登录预加载协议)
    ...
    public heroLoadReq() {
        return new Promise((resolve, reject) => {            
            let msg: any = {};
            msg.type = ProtoType.HERO_LOAD_REQ;
            msg.body = {};
            this.receiveServerMsgOnce(ProtoType.HERO_LOAD_RES, (obj) => {
                this.applyFunc(HeroConst.HERO_LOAD_RES, obj);
                resolve("加载武将信息完成");
            }, this);
    ...
    //             this.applyControllerFunc(ControllerConst.Login,LoginConst.ROLE_PROTOCOL_MONITOR,ProtoType.RANK_LOOKMYSELF_RANK_RES);
